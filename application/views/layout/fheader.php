    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?php base_url()?>/user/home" class="brand-logo">
            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <!-- <li><a class="has" href="javascript:void()">
                         <ul aria-expanded="false"> -->
                            <!-- <li><a href="<?= base_url();?>http://[::1]/task3//admin/Login">Dashboard 1</a></li>
                    ...
                    <!-- <li class="nav-label">Hello There!</li> -->
                              ...
                              <li>
                                ...
                                class="icon icon-chart-bar-33"></i><span class="nav-text">Subjects</span></a>
                                     <ul aria-expanded="false">
                                
                                 <li><a href="<?= base_url();?>/user/fetch_sub_list">Subject List</a></li>
                           
                             </li></ul>


                             <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-chart-bar-33"></i><span class="nav-text">Faculty's</span></a>
                                     <ul aria-expanded="false">
                                
                                 <li><a href="<?= base_url();?>/user/fetch_fac_dep_list">Faculy List</a></li>
