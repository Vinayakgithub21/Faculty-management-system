                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="<?= base_url();?>/admin/Login" method="post">
                                        ...
                                        <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                            <div class="form-group">
                                                <div class="form-check ml-2">
                                                   ...
                                                   &nbsp;
                                                   <input type="radio" name="usertype" value="faculty" >Faculty</input>
                                        ...
                                        <div class="text-center">
                                            <button  type="submit" name="btnsignin" class="btn btn-primary btn-block" value="btnsignin">Sign me in</button>
                                        </div>
                                    </form>
